        ...
        {perfil?.premium ? (
          <>
            <div style={{
              ...
              <span style={{ fontSize: '2em', color: '#2563eb' }}>★</span>
              ¡Ya eres usuario Premium!
              <span style={{ fontSize: '0.95em', color: '#2563ebcc', fontWeight: 400, marginTop: 6 }}>Disfruta de todas las ventajas exclusivas.</span>
            </div>
